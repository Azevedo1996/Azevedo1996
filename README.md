...
[![My Skills](https://skillicons.dev/icons?i=linux,ubuntu,bash,grafana,docker,azure,windows,git,github,python,vmware&perline=11)](https://skillicons.dev)
...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,php,python,bash,git,github&perline=8)](https://skillicons.dev)
...
<table>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p><strong>Status:</strong> Em construção</p>
      <a href="https://github.com/Azevedo1996/iam-security-notes">Ver repositórios</a>
    </td>
    <td width="50%" valign="top">
